...
We'll save these thresholds in a text file and as an RDS object for future reference.
...
# Save as RDS
saveRDS(threshold_list, paste0(project_path, "data/qc/pbmc_thresholds.RDS"))
