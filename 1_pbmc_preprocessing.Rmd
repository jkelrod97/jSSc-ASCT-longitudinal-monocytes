...
# cellranger_paths <- list.files(paste0(project_path, "data/cellranger_output/cellranger_multi"), full.names = TRUE)
# 
# # Get sample names
# samp_names <- list.files(paste0(project_path, "data/cellranger_output/cellranger_multi"))
# 
# # Read 10x output
...
2) Ambient RNA removal with SoupX. Since this step addresses technical noise, we run it separately for each library (subject), so we need output from cellranger multi without demultiplexing (which was run separately for this purpose). 
